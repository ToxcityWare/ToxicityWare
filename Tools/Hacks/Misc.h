...
public:
	...
	static void ClantagChanger()
	{
		...
		if (Options.Misc.Misc1.bClanTag && Options.Misc.Misc1.bCorruption)
		{
			...
			// !<>-_\\/[]{}$#________$$$$
			switch (value) {
			case 0: SetClanTag("Ausky", "Ausky"); break;
			case 1: SetClanTag("A u s k y", "A u s k y"); break;
			case 2: SetClanTag("A  u  s  k  y", "A  u  s  k  y"); break;
