...
void Gui_Init(IDirect3DDevice9* pDevice)
{
	...
	Global::fDefault = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\Verdana.ttf", 12.0f);

	Global::fTabs = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\legacyfont.ttf", 40.0f);
	...
	style.Colors[ImGuiCol_WindowBg] = ImVec4(0.1f, 0.1, 0.1f, 0.8f);
	style.Colors[ImGuiCol_ChildWindowBg] = ImVec4(0.1f, 0.1, 0.1f, 0.8f);
	...
	style.Colors[ImGuiCol_TitleBg] = ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.00f);
	style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.00f);
	style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.00f);
	...
	style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.00f);
	...
	style.Colors[ImGuiCol_Header] = ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.00f);
	style.Colors[ImGuiCol_HeaderHovered] = ImVec4(.50f, 0.50f, 0.50f, .3f); // combobox hover
	style.Colors[ImGuiCol_ComboSelectedText] = ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.00f);
	style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.00f);
...
{
	auto& style = ImGui::GetStyle();
	style.Colors[ImGuiCol_Button] = ImVec4(0.01f, 0.01f, 0.01f, 0.8f);
	style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.01f, 0.01f, 0.01f, 0.8f);
	style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.01f, 0.01f, 0.01f, 0.8f);
...
{
	auto& style = ImGui::GetStyle();
	style.Colors[ImGuiCol_Button] = ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.f);
	style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.f);
	style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.f);
}
...
void DrawRageTab()
{
	...
	if (ImGui::Button("Aimbot", ImVec2(320, 32))) Global::RageSubTab = 0;
	ImGui::SameLine();
	...
	if (Global::RageSubTab == 1)
		...
		style.Colors[ImGuiCol_Text] = ImVec4(.3f, .3f, .3f, 1.f);
	if (ImGui::Button("Anti-Aim", ImVec2(320, 32))) Global::RageSubTab = 1;
	...
	if (Global::RageSubTab == 0)
	{
		ImGui::BeginChild("Aimbot - General", ImVec2(158, 334), true);
		{
			ImGui::Text("Aimbot - General");
			ImGui::Separator();

			ImGui::Checkbox("Enable Aimbot", &Options.Ragebot.Aimbot.bAimbotEnable);
			ImGui::Checkbox("Auto Shoot", &Options.Ragebot.Aimbot.bAutoShoot);
			ImGui::Checkbox("Auto Scope", &Options.Ragebot.Aimbot.bAutoScope);
		...
		ImGui::BeginChild("Aimbot - Accuracy", ImVec2(158, 334), true);
		{
			...
			ImGui::PushItemWidth(125.5);
			ImGui::SliderInt("Min Dmg", &Options.Ragebot.Accuracy.iMinDmg, 0.f, 158.f, "%.f DMG");
		...
		ImGui::SameLine();
		ImGui::BeginChild("Hack vs Hack", ImVec2(158, 334), true);
		{
			...
			ImGui::Text("");
			ImGui::Checkbox("Enable Resolver", &Options.Ragebot.HvH.bResolver);
			ImGui::Combo("##resolver", &Options.Ragebot.HvH.iAntiAimResolver, iResolver, ARRAYSIZE(iResolver));
		}ImGui::EndChild();
		ImGui::SameLine();
		ImGui::BeginChild("FakeLag", ImVec2(158, 334), true);
		{
			ImGui::Text("Fakelag Settings");
			ImGui::Separator();
			ImGui::Combo("##faglag", &Options.Misc.Misc1.iFakeLag, iFakeLag, ARRAYSIZE(iFakeLag));
			ImGui::Checkbox("Air Only", &Options.Misc.Misc1.bInAirOnly);
			ImGui::PushItemWidth(125.5);
	...
	{
		ImGui::BeginChild("##aastand", ImVec2(158, 334), true);
		{		
		...
		ImGui::SameLine();
		ImGui::BeginChild("##aamove", ImVec2(158, 334), true);
		{
		...
		ImGui::SameLine();
		ImGui::BeginChild("##aamisc", ImVec2(158, 334), true);
		{
...
void DrawLegitTab()
{
	...
	if (ImGui::Button("G", ImVec2(108.333333333, 32))) Global::LegitSubTab = 0;
	ImGui::SameLine();
	...
	if (Global::LegitSubTab == 1)
		...
		style.Colors[ImGuiCol_Text] = ImVec4(.3f, .3f, .3f, 1.f);
	if (ImGui::Button("P", ImVec2(108.333333333, 32))) Global::LegitSubTab = 1;
	ImGui::SameLine();
	...
	if (Global::LegitSubTab == 2)
		...
		style.Colors[ImGuiCol_Text] = ImVec4(.3f, .3f, .3f, 1.f);
	if (ImGui::Button("W", ImVec2(108.333333333, 32))) Global::LegitSubTab = 2;
	ImGui::SameLine();
	...
	if (Global::LegitSubTab == 3)
		...
		style.Colors[ImGuiCol_Text] = ImVec4(.3f, .3f, .3f, 1.f);
	if (ImGui::Button("d", ImVec2(108.333333333, 32))) Global::LegitSubTab = 3;
	ImGui::SameLine();
	...
	if (ImGui::Button("f", ImVec2(108.333333333, 32))) Global::LegitSubTab = 4;
	ImGui::SameLine();
	...
	if (Global::LegitSubTab == 5)
		...
		style.Colors[ImGuiCol_Text] = ImVec4(.3f, .3f, .3f, 1.f);
	if (ImGui::Button("a", ImVec2(108.333333333, 32))) Global::LegitSubTab = 5;
	...
	if (Global::LegitSubTab == 0)
	{
		ImGui::BeginChild("Pistols##aimbot", ImVec2(320, 334), true);
		{
			ImGui::Text("Aimbot - Pistols");
			ImGui::Separator();
			ImGui::Checkbox("Enable##", &Options.Legitbot.Aimbot.Pistols.bEnableAimbot);
			ImGui::SameLine();
		...
		ImGui::SameLine();
		ImGui::BeginChild("Pistols##trigger", ImVec2(320, 334), true);
		{
	...
	if (Global::LegitSubTab == 1)
	{
		ImGui::BeginChild("Smgs##aimbot", ImVec2(320, 334), true);
		{

			ImGui::Text("Aimbot - Smgs");
			ImGui::Separator();
			ImGui::Checkbox("Enable##", &Options.Legitbot.Aimbot.Smgs.bEnableAimbot);
			ImGui::SameLine();
		...
		ImGui::SameLine();
		ImGui::BeginChild("Smgs##trigger", ImVec2(320, 334), true);
		{
	...
	if (Global::LegitSubTab == 2)
	{
		ImGui::BeginChild("Rifles##aimbot", ImVec2(320, 334), true);
		{
			ImGui::Text("Aimbot - Rifles");
			ImGui::Separator();
			ImGui::Checkbox("Enable##", &Options.Legitbot.Aimbot.Rifles.bEnableAimbot);
			ImGui::SameLine();
		...
		ImGui::SameLine();
		ImGui::BeginChild("Rifles##trigger", ImVec2(320, 334), true);
		{
	...
	if (Global::LegitSubTab == 3)
	{
		ImGui::BeginChild("Shotguns##aimbot", ImVec2(320, 334), true);
		{
			ImGui::Text("Aimbot - Shotguns");
			ImGui::Separator();
			ImGui::Checkbox("Enable##", &Options.Legitbot.Aimbot.Shotguns.bEnableAimbot);
			ImGui::SameLine();
		...
		ImGui::SameLine();
		ImGui::BeginChild("Shotguns##trigger", ImVec2(320, 334), true);
		{
	...
	if (Global::LegitSubTab == 4)
	{
		ImGui::BeginChild("Heavy##aimbot", ImVec2(320, 334), true);
		{
			ImGui::Text("Aimbot - Heavy");
			ImGui::Separator();
			ImGui::Checkbox("Enable##", &Options.Legitbot.Aimbot.Heavy.bEnableAimbot);
			ImGui::SameLine();
		...
		ImGui::SameLine();
		ImGui::BeginChild("Heavy##trigger", ImVec2(320, 334), true);
		{
	...
	if (Global::LegitSubTab == 5)
	{
		ImGui::BeginChild("Snipers##aimbot", ImVec2(320, 334), true);
		{
			ImGui::Text("Aimbot - Snipers");
			ImGui::Separator();
			ImGui::Checkbox("Enable##", &Options.Legitbot.Aimbot.Snipers.bEnableAimbot);
			ImGui::SameLine();
		...
		ImGui::SameLine();
		ImGui::BeginChild("Snipers##trigger", ImVec2(320, 334), true);
		{
...
void DrawVisualsTab()
{
	...
	style.ItemSpacing = ImVec2(0, 4);
	style.Colors[ImGuiCol_Text] = ImVec4(0.98f, 0.98f, 0.98f, 1.f);
	if (ImGui::Button("Visuals", ImVec2(650, 32)));

	style.WindowPadding = ImVec2(8, 8);
	style.ItemSpacing = ImVec2(4, 4);
	ImGui::BeginChild("ESP - General", ImVec2(158, 334), true);
	{
		ImGui::Text("ESP - Main");
		ImGui::Separator();
	...
	ImGui::BeginChild("ESP - Misc", ImVec2(158, 334), true);
	{
		...
		ImGui::Checkbox("No Scope", &Options.Visuals.VisualsMisc.bScopeRemover);
		ImGui::Checkbox("No Flashes", &Options.Visuals.VisualsWorlds.bNoFlash);
		ImGui::Checkbox("No Smokes", &Options.Visuals.VisualsWorlds.bNoSmoke);
		ImGui::Checkbox("No Visual Recoil", &Options.Visuals.VisualsMisc.bNoVisualRecoil);
		ImGui::Separator();
		ImGui::Text("Infobox");
		ImGui::Separator();
	...
	ImGui::SameLine();
	ImGui::BeginChild("Visuals - Misc", ImVec2(158, 334), true);
	{
		...
		ImGui::Checkbox("Color Modulation", &Options.Visuals.VisualsWorlds.bColorMod);
		ImGui::Checkbox("Asus Walls", &Options.Visuals.VisualsWorlds.bAsusWalls);
		ImGui::PushItemWidth(125.5);
		ImGui::SliderFloat("Asus %", &Options.Visuals.VisualsWorlds.flAsusFactor, 5, 25, "%.1f", (1.0F));
	}ImGui::EndChild();
	ImGui::SameLine();
	ImGui::BeginChild("Chams", ImVec2(158, 334), true);
	{
		ImGui::Text("Chams");
		ImGui::Separator();
		ImGui::Text("	Models");
...
void DrawMiscTab()
{
	...
	style.ItemSpacing = ImVec2(0, 4);
	style.Colors[ImGuiCol_Text] = ImVec4(0.98f, 0.98f, 0.98f, 1.f);
	if (ImGui::Button("Miscellanious", ImVec2(650, 32)));
	style.WindowPadding = ImVec2(8, 8);
	style.ItemSpacing = ImVec2(4, 4);

	ImGui::BeginChild("Misc I", ImVec2(158, 334), true);
	{
		ImGui::Text("Misc I");
		ImGui::Separator();
		...
		ImGui::Text("");
		ImGui::Checkbox("Active Status", &Options.Misc.Misc1.bSkinToggle);
	}ImGui::EndChild();
	ImGui::SameLine();
	ImGui::BeginChild("Misc II", ImVec2(158, 334), true);
	{
		ImGui::Text("Misc II");
		ImGui::Separator();
		...
		ImGui::PushItemWidth(125.5);
		ImGui::SliderFloat("FOV Value", &Options.Misc.Misc2.flFovValue, 30.f, 158.f, "%.f", 1.f);
		ImGui::PushItemWidth(125.5);
		ImGui::SliderFloat("viewmodelFOV Value", &Options.Misc.Misc2.flViewModelValue, 30.f, 158.f, "%.f", 1.f);
	}ImGui::EndChild();	
	ImGui::SameLine();
	ImGui::BeginChild("Movements", ImVec2(158, 334), true);
	{
		ImGui::Text("Movement");
		ImGui::Separator();
	...
	ImGui::SameLine();
	ImGui::BeginChild("AutoBots", ImVec2(158, 334), true);
	ImGui::Text("Bots");
	ImGui::Separator();
	...
	ImGui::Separator();
	ImGui::Text("Configs");
	ImGui::Combo("##configs", &Options.Config.iConfigs, iConfigNames, ARRAYSIZE(iConfigNames));
...
void DrawColorsTab()
{
	ImGui::BeginChild("##visualscolors", ImVec2(772, 374), true);
	{
...
HRESULT __stdcall Hooked_EndScene(IDirect3DDevice9* pDevice)
{
	...
	if (Global::MenuOpen)
	{
		...
		ImGui::SetNextWindowSize(ImVec2(650, 375));
		ImGui::SetNextWindowPos(ImVec2(75, 0));
		style.Colors[ImGuiCol_WindowBg] = ImVec4(0.01f, 0.01f, 0.01f, 0.8f);
		ImGui::Begin("Hurensohn Visual Studio", &Global::MenuOpen, ImVec2(650, 375), 0.98f, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoMove);
		{
			style.Colors[ImGuiCol_WindowBg] = ImVec4(0.01f, 0.01f, 0.01f, 0.8f);
		...
		ImGui::SetNextWindowSize(ImVec2(75, 375));

		ImGui::Begin("##tabarea", &Global::MenuOpen, ImVec2(75, 375), 0.f, ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoFocusOnAppearing | ImGuiWindowFlags_NoTitleBar);
		{
			...
			if (ImGui::Button("a", ImVec2(75, 75))) Global::MenuTab = 0;

			if (Global::MenuTab == 1) BtnActive(); else BtnNormal();
			if (ImGui::Button("b", ImVec2(75, 75))) Global::MenuTab = 1;

			if (Global::MenuTab == 2) BtnActive(); else BtnNormal();
			if (ImGui::Button("c", ImVec2(75, 75))) Global::MenuTab = 2;

			if (Global::MenuTab == 3) BtnActive(); else BtnNormal();
			if (ImGui::Button("d", ImVec2(75, 75))) Global::MenuTab = 3;

			if (Global::MenuTab == 4) BtnActive(); else BtnNormal();
			if (ImGui::Button("e", ImVec2(75, 75))) Global::MenuTab = 4;
	...
	if (Options.Visuals.Infobox.bInfoBox)
	{
		...
		style.WindowPadding = ImVec2(8, 8);
		style.ItemSpacing = ImVec2(4, 4);
		style.Colors[ImGuiCol_WindowBg] = ImVec4(0.01f, 0.01f, 0.01f, 0.95f);
		ImGui::Begin("Infobox", &Options.Visuals.Infobox.bInfoBox, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_ShowBorders | ImGuiWindowFlags_NoTitleBar);
		{
			ImGui::Text("                 Infobox");
			ImGui::Separator();
			ImGui::Spacing();
	...
	if (Options.Misc.Misc1.bSkinToggle)
	{
		style.Alpha = 1.f;
		style.WindowMinSize = ImVec2(130, 40);
		style.WindowPadding = ImVec2(8, 8);
		style.ItemSpacing = ImVec2(4, 4);
		style.Colors[ImGuiCol_WindowBg] = ImVec4(0.1f, 0.1f, 0.1f, 0.001f);
		ImGui::PushFont(Global::fDefault);
		ImGui::Begin("Active Cheats", &Options.Misc.Misc1.bSkinToggle, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_ShowBorders | ImGuiWindowFlags_NoTitleBar);
		{
			...
			ImGui::TextColored(ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.f), "Cheat Status: ");
			ImGui::Separator();
			ImGui::TextColored(ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.f), "Legit: ");
			if (Options.Legitbot.Aimbot.Pistols.bEnableAimbot || Options.Legitbot.Aimbot.Rifles.bEnableAimbot || Options.Legitbot.Aimbot.Snipers.bEnableAimbot || Options.Legitbot.Aimbot.Heavy.bEnableAimbot || Options.Legitbot.Aimbot.Smgs.bEnableAimbot || Options.Legitbot.Aimbot.Shotguns.bEnableAimbot)
			{
				ImGui::SameLine();
				ImGui::TextColored(ImVec4(0, 1, 0, 1.f), "ENABLED");

			}
			else
			{
				ImGui::SameLine();
				ImGui::TextColored(ImVec4(1, 0, 0, 1.f), "DISABLED");
			}
			ImGui::TextColored(ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.f), "Rage: ");
			if (Options.Ragebot.Aimbot.bAimbotEnable || Options.Ragebot.Accuracy.bNoRecoil || Options.Ragebot.AntiAim.Stand.bEnableAntiAim || Options.Ragebot.AntiAim.Move.bEnableAntiAim || Options.Ragebot.AntiAim.Edge.bEnableEdge)
			{
				ImGui::SameLine();
				ImGui::TextColored(ImVec4(0, 1, 0, 1.f), "ENABLED");
			...
			ImGui::TextColored(ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.f), "Visuals: ");
			if (115)
			{
				ImGui::SameLine();
				ImGui::TextColored(ImVec4(0, 1, 0, 1.f), "ENABLED");
			...
			ImGui::TextColored(ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.f), "Miscellanious: ");
			if (115)
			{
				ImGui::SameLine();
				ImGui::TextColored(ImVec4(0, 1, 0, 1.f), "ENABLED");
			...
			ImGui::TextColored(ImVec4(0.54117647058f, 0.16470588235f, 0.8862745098f, 1.f), "Skins: ");
			if (115)
			{
				ImGui::SameLine();
				ImGui::TextColored(ImVec4(0, 1, 0, 1.f), "ENABLED");
		...
		if (Interfaces.pEngine->IsInGame() && Interfaces.pEngine->IsConnected())
		{
			...
			if (Hacks.LocalPlayer)
			{
				...
				ImGui::Begin("Spectator List", &Options.Visuals.Infobox.bInfoBox, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_ShowBorders);
				{
					...
					ImGui::SetWindowSize(ImVec2(320, 20 + siz.y));
