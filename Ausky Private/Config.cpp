...
void CConfig::Setup()
{
			...
			SetupValue(Options.Ragebot.HvH.bResolver, false, "Rage_Aimbot", "bResolver");
			...
			SetupValue(Options.Visuals.VisualsWorlds.bColorMod, false, "Visuals_VisualsWorlds", "bColorMod");
			...
			SetupValue(Options.Col.colormod[0], .3f, "Colors", "colormod1");
			SetupValue(Options.Col.colormod[1], .3f, "Colors", "colormod2");
			SetupValue(Options.Col.colormod[2], .3f, "Colors", "colormod3");

			SetupValue(Options.Col.colormodProps[0], .3f, "Colors", "colormodProps1");
			SetupValue(Options.Col.colormodProps[1], .3f, "Colors", "colormodProps2");
			SetupValue(Options.Col.colormodProps[2], .3f, "Colors", "colormodProps3");

			SetupValue(Options.Col.colormodModels[0], .3f, "Colors", "colormodModels1");
			SetupValue(Options.Col.colormodModels[1], .3f, "Colors", "colormodModels2");
			SetupValue(Options.Col.colormodModels[2], .3f, "Colors", "colormodModels3");
}
...
void CConfig::Save()
{
	...
	switch (Options.Config.iConfigs)
	{
	case 0:
		if (SUCCEEDED(SHGetFolderPath(NULL, CSIDL_APPDATA, NULL, 0, path)))
		{
			folder = std::string(path) + "\\Ausky\\";
			file = std::string(path) + "\\Ausky\\Legit.ini";
		}
		break;
	case 1:
		if (SUCCEEDED(SHGetFolderPath(NULL, CSIDL_APPDATA, NULL, 0, path)))
		{
			folder = std::string(path) + "\\Ausky\\";
			file = std::string(path) + "\\Ausky\\Spread.ini";
		}
		break;
	case 2:
		if (SUCCEEDED(SHGetFolderPath(NULL, CSIDL_APPDATA, NULL, 0, path)))
		{
			folder = std::string(path) + "\\Ausky\\";
			file = std::string(path) + "\\Ausky\\NoSpread.ini";
		}
		break;
	}
