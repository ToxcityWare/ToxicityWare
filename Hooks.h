...
public:
	...
	void Hook()
	{
		...
		*/
		...
		Interfaces.pSurface->SetFontGlyphSet( Font_Icon, "icomoon", 42, 400, 0, 0, FONTFLAG_ANTIALIAS );
		Interfaces.pSurface->SetFontGlyphSet( Font_Weapons, "icomoon", 12, 500, 0, 0, FONTFLAG_ANTIALIAS);
		...
		auto __FONT = CreateFont( 16, 0, 0, 0, 500, 0, 0, 0, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH | FF_DONTCARE, "undefeated.tff" );
		
		
		CreateDirectory("C:\\Ausky", NULL);
		//Global::configpath = "C:\\Ausky\\config.ini";
		// Hooks
